...
public class TopicInfoWriteServiceImpl implements TopicInfoWriteService {
    ...
    public long saveTopicInfo(TopicAddReq topicAddReq, MultipartFile coverImage) {
        ...
        String coverImageUrl = minioUtils.upload(inputStream, url, FileFormat.WEBP_CONTENT_TYPE);
        //过滤标题
    ...
    public void updateHtml(TopicModifyHtmlReq modifyReq) {
        ...
        if (topicHtml != null) {
            List<String> oldUrls = HtmlUtils.getInnerImageUrlsAndRemoveRepeat(topicHtml.getHtml());
            List<String> newUrls = HtmlUtils.getInnerImageUrlsAndRemoveRepeat(modifyReq.getHtml());
